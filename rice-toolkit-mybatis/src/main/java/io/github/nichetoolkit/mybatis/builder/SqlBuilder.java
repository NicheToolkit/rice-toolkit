...
public final class SqlBuilder implements Serializable, CharSequence {
    ...
    /**
     * <code>curlyLt</code>
     * <p>The curly lt method.</p>
     * @return {@link io.github.nichetoolkit.mybatis.builder.SqlBuilder} <p>The curly lt return object is <code>SqlBuilder</code> type.</p>
     */
    public SqlBuilder curlyLt() {
        this.blank().append(SQLConstants.CURLY_LT);
        return this;
    }

    /**
     * <code>curlyGt</code>
     * <p>The curly gt method.</p>
     * @return {@link io.github.nichetoolkit.mybatis.builder.SqlBuilder} <p>The curly gt return object is <code>SqlBuilder</code> type.</p>
     */
    public SqlBuilder curlyGt() {
        this.append(SQLConstants.CURLY_GT).blank();
        return this;
    }
     ...
     * @return {@link io.github.nichetoolkit.mybatis.builder.SqlBuilder} <p>The signer return object is <code>SqlBuilder</code> type.</p>
     * @see java.lang.String
     */
    public SqlBuilder signer(String name) {
        this.append(SQLConstants.SIGNER).curlyLt().append(name).curlyGt();
        return this;
    }

    /**
     * <code>dollar</code>
     * <p>The dollar method.</p>
     * @param name {@link java.lang.String} <p>The name parameter is <code>String</code> type.</p>
     * @return {@link io.github.nichetoolkit.mybatis.builder.SqlBuilder} <p>The dollar return object is <code>SqlBuilder</code> type.</p>
     * @see java.lang.String
     */
    public SqlBuilder dollar(String name) {
        this.append(SQLConstants.DOLLAR).curlyLt().append(name).curlyGt();
        return this;
    }
