...
public interface RestFickleType extends RestType, Serializable {
    ...
    class OfRestFickleType extends RestType.OfRestType implements RestFickleType {
         ...
         * <code>OfRestFickleType</code>
         * <p>Instantiates a new of rest fickle type.</p>
         * @param type {@link io.github.nichetoolkit.mybatis.enums.MybatisType} <p>The type parameter is <code>MybatisType</code> type.</p>
         * @see io.github.nichetoolkit.mybatis.enums.MybatisType
         */
        public OfRestFickleType(MybatisType type) {
         ...
         * @see java.lang.String
         */
        public OfRestFickleType(MybatisType type, String value) {
         ...
         * @see java.lang.Class
         */
        public OfRestFickleType(MybatisType type, Class<?> clazz) {
