...
public interface RestStyle {
     ...
     * @return  {@link io.github.nichetoolkit.mybatis.RestStyle} <p>The default style return object is <code>RestStyle</code> type.</p>
     */
     ...
     * @return  {@link io.github.nichetoolkit.mybatis.RestStyle} <p>The style return object is <code>RestStyle</code> type.</p>
     */
