...
import io.github.nichetoolkit.rice.consts.DriverConstants;
...
public enum DatabaseType implements RestValue<String, String> {
     ...
     * @return  {@link io.github.nichetoolkit.rice.enums.DatabaseType} <p>The parse key return object is <code>DatabaseType</code> type.</p>
     */
    @JsonCreator
     ...
     * @param value {@link java.lang.String} <p>The value parameter is <code>String</code> type.</p>
     * @see  java.lang.String
     * @return  {@link io.github.nichetoolkit.rice.enums.DatabaseType} <p>The parse value return object is <code>DatabaseType</code> type.</p>
     */
