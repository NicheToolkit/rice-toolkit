 ...
 * @see  io.github.nichetoolkit.rice.table.RestTableStyle
 * @see  io.github.nichetoolkit.rice.table.RestIgnores
 * @see  io.github.nichetoolkit.rice.table.RestResultMap
 * @see  io.github.nichetoolkit.rice.table.RestProperties
 * @see  io.github.nichetoolkit.rice.table.RestExcludes
 * @see  io.github.nichetoolkit.rice.table.RestUnionKeys
 * @see  io.github.nichetoolkit.rice.table.RestLinkKeys
 * @see  io.github.nichetoolkit.rice.table.RestUniqueKeys
 * @see  io.github.nichetoolkit.rice.table.RestAlertKeys
...
public @interface RestTable {
     ...
     * @return  {@link io.github.nichetoolkit.rice.enums.StyleType} <p>The style type return object is <code>StyleType</code> type.</p>
