...
import io.github.nichetoolkit.rest.configure.RestStarterAutoConfigure;
...
@Slf4j
@AutoConfiguration
@AutoConfigureAfter({RiceContextAutoConfigure.class, RestStarterAutoConfigure.class})
@ImportAutoConfiguration(value = {RiceServiceAutoConfigure.class,RiceLoginAutoConfigure.class})
