 ...
 * @version v1.0.0
 */
public abstract class RiceInfoEntity<E extends RiceInfoEntity<E,M>,M extends RiceInfoModel<M,E>> extends InfoEntity<String> implements RiceEntity<String,M> {
