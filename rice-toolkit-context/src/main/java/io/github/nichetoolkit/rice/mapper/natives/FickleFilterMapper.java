...
public interface FickleFilterMapper<E extends RestId<I>, I> {
     ...
     * @see java.util.List
     */
    List<E> findAllByFickleLoadWhere(@Param("whereSql") String whereSql, @Param("fickleParams") RestFickle<?>[] fickleParams, @Param("loadParams") Boolean... loadParams);
     ...
     * @see java.util.List
     */
    List<E> findDynamicAllByFickleLoadWhere(@Param("tablename") String tablename, @Param("whereSql") String whereSql, @Param("fickleParams") RestFickle<?>[] fickleParams, @Param("loadParams") Boolean... loadParams);
