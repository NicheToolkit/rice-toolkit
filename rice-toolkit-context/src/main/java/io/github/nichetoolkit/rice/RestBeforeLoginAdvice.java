...
/**
 * <code>RestBeforeLoginAdvice</code>
 * <p>The rest before login advice interface.</p>
...
public interface RestBeforeLoginAdvice<A extends Annotation> extends Comparable<RestBeforeLoginAdvice<A>>{
    ...
    default Class<A> clazz() {
        return (Class<A>) RestGenericTypes.resolveClass(RestGenericTypes.resolveType(
                RestBeforeLoginAdvice.class.getTypeParameters()[0], getClass(), RestBeforeLoginAdvice.class));
    }
    ...
    @Override
    default int compareTo(RestBeforeLoginAdvice advice) {
