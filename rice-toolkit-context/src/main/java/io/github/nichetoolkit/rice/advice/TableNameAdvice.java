 ...
 * <p>The table name advice interface.</p>
...
public interface TableNameAdvice<M extends RestId<I>, I, K> {
     ...
     * <p>The resolve table name method.</p>
     * @param tableKey {@link io.github.nichetoolkit.rice.RestTableKey} <p>The table key parameter is <code>RestTableKey</code> type.</p>
     * @return {@link java.lang.String} <p>The resolve table name return object is <code>String</code> type.</p>
