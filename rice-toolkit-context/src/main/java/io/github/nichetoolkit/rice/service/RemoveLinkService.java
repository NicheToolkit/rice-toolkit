...
public interface RemoveLinkService<I, K> extends RemoveService<I, K> {
     ...
     * @see io.github.nichetoolkit.rest.RestException
     */
    <L> void removeAllByLinkIds(RestTablekey<K> tablekey, Collection<L> linkIdList) throws RestException;
     ...
     * @see io.github.nichetoolkit.rest.RestException
     */
    <L> void removeByLinkId(RestTablekey<K> tablekey, L linkId) throws RestException;
     ...
     * @see io.github.nichetoolkit.rest.RestException
     */
    <L> void removeAllByLinkIds(RestTablekey<K> tablekey, Collection<L> linkIdList, RestKey<String> linkName) throws RestException;
     ...
     * @see io.github.nichetoolkit.rest.RestException
     */
    <L> void removeByLinkId(RestTablekey<K> tablekey, L linkId, RestKey<String> linkName) throws RestException;
