...
public interface FickleLoadMapper<E extends RestId<I>, I> {
     ...
     */
    E findByIdFickleLoad(@Param("id") I id, @Param("fickleParams") RestFickle<?>[] fickleParams, @Param("loadParams") Boolean... loadParams);
     ...
     * @see java.lang.Boolean
     */
    E findDynamicByIdFickleLoad(@Param("tablename") String tablename, @Param("id") I id, @Param("fickleParams") RestFickle<?>[] fickleParams, @Param("loadParams") Boolean... loadParams);
     ...
     * @see java.util.List
     */
    List<E> findAllFickleLoad(@Param("idList") Collection<I> idList, @Param("fickleParams") RestFickle<?>[] fickleParams, @Param("loadParams") Boolean... loadParams);
     ...
     * @see java.util.List
     */
    List<E> findDynamicAllFickleLoad(@Param("tablename") String tablename, @Param("idList") Collection<I> idList, @Param("fickleParams") RestFickle<?>[] fickleParams, @Param("loadParams") Boolean... loadParams);
