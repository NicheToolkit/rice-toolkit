...
public interface LinkLoadMapper<E extends RestId<I>, L, I> {
     ...
     * @see java.util.List
     */
    List<E> findByLinkIdLoad(@Param("linkId") L linkId, @Param("loadParams") RestLoad... loadParams);
     ...
     * @see java.util.List
     */
    List<E> findAllByLinkIdsLoad(@Param("linkIdList") Collection<L> linkIdList, @Param("loadParams") RestLoad... loadParams);
