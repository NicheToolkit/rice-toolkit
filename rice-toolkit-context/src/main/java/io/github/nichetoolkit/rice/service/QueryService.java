...
public interface QueryService<M extends RestId<I>, I, K> extends DeleteService<I, K> {
     ...
     * @throws RestException {@link io.github.nichetoolkit.rest.RestException} <p>The rest exception is <code>RestException</code> type.</p>
     */
    List<M> queryAll(Collection<I> idList, Collection<RestKey<String>> fickleList, Boolean... isLoadArray) throws RestException;
     ...
     * @throws RestException {@link io.github.nichetoolkit.rest.RestException} <p>The rest exception is <code>RestException</code> type.</p>
     */
    List<M> queryAll(K tablekey, Collection<I> idList, Collection<RestKey<String>> fickleList, Boolean... isLoadArray) throws RestException;
     ...
     * @throws RestException {@link io.github.nichetoolkit.rest.RestException} <p>The rest exception is <code>RestException</code> type.</p>
     */
    M queryById(I id, Collection<RestKey<String>> fickleList, Boolean... isLoadArray) throws RestException;
     ...
     * @throws RestException {@link io.github.nichetoolkit.rest.RestException} <p>The rest exception is <code>RestException</code> type.</p>
     */
    M queryById(K tablekey, I id, Collection<RestKey<String>> fickleList, Boolean... isLoadArray) throws RestException;
