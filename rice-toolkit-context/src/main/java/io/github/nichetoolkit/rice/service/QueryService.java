...
public interface QueryService<M extends RestId<I>, I, K> extends DeleteService<I, K> {
     ...
     * @see io.github.nichetoolkit.rest.RestException
     */
    List<M> queryAll(K tablekey, Collection<I> idList, RestLoad... isLoadArray) throws RestException;
     ...
     * @see io.github.nichetoolkit.rest.RestException
     */
    M queryById(K tablekey, I id, RestLoad... isLoadArray) throws RestException;
