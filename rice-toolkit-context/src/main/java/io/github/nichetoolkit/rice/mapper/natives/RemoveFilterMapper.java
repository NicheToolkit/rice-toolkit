 ...
 * @since Jdk1.8
 */
public interface RemoveFilterMapper<E extends IdEntity<I>, F extends IdFilter<I, K>, I, K> extends FindFilterMapper<E, F, I, K> {
     ...
     */
    Integer removeAllByFilterWhere(@Param("whereSql") String whereSql, @Param("filter") F filter, @Param("logicSign") String logicSign);
     ...
     * @see java.lang.Integer
     */
    Integer removeDynamicAllByFilterWhere(@Param("tablename") String tablename, @Param("whereSql") String whereSql, @Param("filter") F filter, @Param("logicSign") String logicSign);
}
