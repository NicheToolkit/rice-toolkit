...
public interface MutateAdvice<M extends RestId<I>, E extends RestId<I>, I> {
     ...
     */
    M mutateEntity(E entity, RestLoad... isLoadArray) throws RestException;
     ...
     * @see io.github.nichetoolkit.rest.RestException
     */
    List<M> mutateEntityList(List<E> entityList, ConsumerActuator<E> actuator, RestLoad... isLoadArray) throws RestException;
