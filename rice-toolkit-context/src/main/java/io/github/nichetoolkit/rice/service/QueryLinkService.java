...
public interface QueryLinkService<M extends RestId<I>, I, K> extends QueryService<M, I, K> {
     ...
     * @see io.github.nichetoolkit.rest.RestException
     */
    <L> List<M> queryAllByLinkIds(Collection<L> linkIdList, Collection<RestKey<String>> fickleList, Boolean... isLoadArray) throws RestException;
     ...
     * @see io.github.nichetoolkit.rest.RestException
     */
    <L> List<M> queryAllByLinkIds(K tablekey, Collection<L> linkIdList, Collection<RestKey<String>> fickleList, Boolean... isLoadArray) throws RestException;
     ...
     * @see io.github.nichetoolkit.rest.RestException
     */
    <L> List<M> queryAllByLinkIds(Collection<L> linkIdList, RestKey<String> linkName, Collection<RestKey<String>> fickleList, Boolean... isLoadArray) throws RestException;
     ...
     * @see io.github.nichetoolkit.rest.RestException
     */
    <L> List<M> queryAllByLinkIds(K tablekey, Collection<L> linkIdList, RestKey<String> linkName, Collection<RestKey<String>> fickleList, Boolean... isLoadArray) throws RestException;
