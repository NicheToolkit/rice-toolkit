...
/**
 * <code>RestAfterLoginAdvice</code>
 * <p>The rest after login advice interface.</p>
 ...
 * @since Jdk1.8
 */
public interface RestAfterLoginAdvice<A extends Annotation> extends Comparable<RestAfterLoginAdvice<A>>{
    ...
    default Class<A> clazz() {
        return (Class<A>) RestGenericTypes.resolveClass(RestGenericTypes.resolveType(
                RestAfterLoginAdvice.class.getTypeParameters()[0], getClass(), RestAfterLoginAdvice.class));
    }
    ...
    @Override
    default int compareTo(RestAfterLoginAdvice advice) {
