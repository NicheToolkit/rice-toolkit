...
public interface DeleteLinkService<I,K> extends DeleteService<I,K> {
     ...
     * @throws RestException {@link io.github.nichetoolkit.rest.RestException} <p>The rest exception is <code>RestException</code> type.</p>
     */
    <L> void deleteAllByLinkIds(K tablekey, Collection<L> linkIdList, RestKey<String> linkName) throws RestException;
     ...
     * @throws RestException {@link io.github.nichetoolkit.rest.RestException} <p>The rest exception is <code>RestException</code> type.</p>
     */
    <L> void deleteByLinkId(K tablekey, L linkId, RestKey<String> linkName) throws RestException;
