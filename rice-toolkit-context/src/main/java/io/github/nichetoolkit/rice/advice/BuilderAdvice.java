...
public interface BuilderAdvice<M extends RestId<I>, E extends RestId<I>, I> {
     ...
     * @see io.github.nichetoolkit.rest.RestException
     */
    default void buildModel(E entity, M model, RestLoad... isLoadArray) throws RestException {
    }
     ...
     * @see io.github.nichetoolkit.rest.RestException
     */
    default void buildModelList(Collection<E> entityList, List<M> modelList, RestLoad... isLoadArray) throws RestException {
    }
