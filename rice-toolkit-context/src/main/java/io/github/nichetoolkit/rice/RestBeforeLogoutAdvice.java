...
/**
 * <code>RestBeforeLogoutAdvice</code>
 * <p>The rest before logout advice interface.</p>
 ...
 * @since Jdk1.8
 */
public interface RestBeforeLogoutAdvice<A extends Annotation> extends Comparable<RestBeforeLogoutAdvice<A>>{
    ...
    default Class<A> clazz() {
        return (Class<A>) RestGenericTypes.resolveClass(RestGenericTypes.resolveType(
                RestBeforeLogoutAdvice.class.getTypeParameters()[0], getClass(), RestBeforeLogoutAdvice.class));
    }
    ...
    @Override
    default int compareTo(RestBeforeLogoutAdvice advice) {
