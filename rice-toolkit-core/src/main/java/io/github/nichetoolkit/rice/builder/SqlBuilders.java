...
public class SqlBuilders {
    ...
    /**
     * <code>equalOrNull</code>
     * <p>The equal or null method.</p>
     * @param sqlBuilder {@link java.lang.StringBuilder} <p>The sql builder parameter is <code>StringBuilder</code> type.</p>
     * @param target     {@link java.lang.String} <p>The target parameter is <code>String</code> type.</p>
     * @param value      {@link java.lang.Object} <p>The value parameter is <code>Object</code> type.</p>
     * @return {@link io.github.nichetoolkit.mybatis.builder.SqlBuilder} <p>The equal or null return object is <code>SqlBuilder</code> type.</p>
     * @see java.lang.StringBuilder
     * @see java.lang.Object
     * @see io.github.nichetoolkit.mybatis.builder.SqlBuilder
     */
    public static SqlBuilder equalOrNull(StringBuilder sqlBuilder, String target, Object value) {
        return newSqlBuilder(sqlBuilder).and().braceLt().eq(target, value, null).isn(target,false).braceGt();
    }
     ...
     * @see java.lang.Object
     */
    public static void equalOrNull(SqlBuilder sqlBuilder, String target, Object value) {
        sqlBuilder.and().braceLt().eq(target, value, null).isn(target,false).braceGt();
    }
     ...
     * @return {@link io.github.nichetoolkit.mybatis.builder.SqlBuilder} <p>The equal or sql return object is <code>SqlBuilder</code> type.</p>
     * @see java.lang.StringBuilder
     * @see java.lang.Object
     * @see io.github.nichetoolkit.mybatis.builder.SqlBuilder
     */
    public static SqlBuilder equalOrSql(StringBuilder sqlBuilder, String target, Object value, StringBuilder sql) {
        return newSqlBuilder(sqlBuilder).and().braceLt().eq(target, value, null).or().append(sql).braceGt();
    }
     ...
     * @see java.lang.Object
     */
    public static void equalOrSql(SqlBuilder sqlBuilder, String target, Object value, SqlBuilder sql) {
     ...
     * @see io.github.nichetoolkit.mybatis.builder.SqlBuilder
     */
    public static SqlBuilder equalOrSql(StringBuilder sqlBuilder, String target, Object value, String sql) {
        return newSqlBuilder(sqlBuilder).and().braceLt().eq(target, value, null).or().append(sql).braceGt();
    }
    ...
    /**
     * <code>nullOrSql</code>
     * <p>The null or sql method.</p>
     * @param sqlBuilder {@link java.lang.StringBuilder} <p>The sql builder parameter is <code>StringBuilder</code> type.</p>
     * @param target     {@link java.lang.String} <p>The target parameter is <code>String</code> type.</p>
     * @param sql        {@link java.lang.String} <p>The sql parameter is <code>String</code> type.</p>
     * @return {@link io.github.nichetoolkit.mybatis.builder.SqlBuilder} <p>The null or sql return object is <code>SqlBuilder</code> type.</p>
     * @see java.lang.StringBuilder
     * @see io.github.nichetoolkit.mybatis.builder.SqlBuilder
     */
    public static SqlBuilder nullOrSql(StringBuilder sqlBuilder, String target, String sql) {
        return newSqlBuilder(sqlBuilder).and().braceLt().isn(target, null).or().append(sql).braceGt();
    }
     ...
     * @see java.lang.String
     */
    public static void nullOrSql(SqlBuilder sqlBuilder, String target, String sql) {
        sqlBuilder.and().braceLt().isn(target, null).or().append(sql).braceGt();
    }
     ...
     * @see io.github.nichetoolkit.mybatis.builder.SqlBuilder
     */
    public static SqlBuilder nullOrSql(StringBuilder sqlBuilder, String target, StringBuilder sql) {
        return newSqlBuilder(sqlBuilder).and().braceLt().isn(target, null).or().append(sql).braceGt();
    }
     ...
     * @see java.lang.String
     */
    public static void nullOrSql(SqlBuilder sqlBuilder, String target, SqlBuilder sql) {
        sqlBuilder.and().braceLt().isn(target, null).or().append(sql).braceGt();
    }
